...
void Mejora::Fisica()
{
    ...
    if (aspecto_f == 1)
    {
        ...
        }while(opcion_abdominales>7 || opcion_abdominales<=0);
        ...
        else if(opcion_abdominales==2)
        {
            ...
            cout<<"\t Primero colocate de pie, luego apoyando las manos en el suelo, \n\n";
    ...
    else if(aspecto_f == 2)
    {
        ...
        cout<<"5. GEMELOS. \n\n";
        cin>>opcion_piernas;
        }while(opcion_piernas>5 || opcion_piernas<=0);
    ...
    else if(aspecto_f==3)
    {
        ...
        cin>>opcion_brazos;
        }while(opcion_brazos>7 || opcion_brazos<=0);
                    ...
                    else if(opcion_brazos==5)
                    {
                        ...
                        cout<<"\t Desde ahí, flexionamos los codos para bajar con la \n\n";
                    ...
                    else if(opcion_brazos==6)
                    {
                        ...
                        cout<<"\t Desde ahí, empujalas hacia el techo por encima \n\n";
    ...
    else if(aspecto_f==4)
    {
        ...
        cout<<"4. PULLOVER. \n\n";
        cin>>opcion_espalda;
        }while(opcion_espalda>4 || opcion_espalda<=0);
